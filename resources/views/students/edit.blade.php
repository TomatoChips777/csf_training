            ...
            <form method="POST" action="{{ route('students.update', $student->id) }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="dob" name="dob" type="date" class="mt-1 block w-full" value="{{ old('dob', $student->dob) }}" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="course_year" name="course_year" type="text" class="mt-1 block w-full" value="{{ old('course_year', $student->course_year) }}" required />
                    ...
                    <div>
                        ...
                        @if($student->photo)
                            <img src="{{ asset('storage/'.$student->photo) }}" alt="Photo" class="h-20 w-20 object-cover mb-2">
                        @endif
                ...
                <div class="mt-4">
                    ...
                    <textarea id="address" name="address" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('address', $student->address) }}</textarea>
